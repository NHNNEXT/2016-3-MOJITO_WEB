...
INSERT INTO MEETING (capacity, contents, cur_participant_num, location, writer_id, create_date, expire_date, meeting_date) VALUES (5, '홍대에서 코딩할 건데 같이 하실 분?', 3, '홍대 카페 거리', 1, current_timestamp(), current_timestamp(), current_timestamp());
